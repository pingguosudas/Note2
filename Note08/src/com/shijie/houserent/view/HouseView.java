package com.shijie.houserent.view;

import com.shijie.houserent.domain.House;
import com.shijie.houserent.service.HouseService;
import com.shijie.houserent.utils.Utility;
...
//        String findAddress = Utility.readString(12);
//        //调用方法
//        House house = houseService.findByAddress(findAddress);
//        if (house != null) {
//            System.out.println(house);
//        } else {
//            System.out.println("-------------查找房屋信息地区不存在-------------");
//        }
//    }
    ...
    public void listHouses() {
        ...
        for (int i = 0; i < houses.length; i++) {//想想,这里有什么问题
